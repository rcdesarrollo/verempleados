		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ver empleados",
									"targetURL": "#mineramcverempleados-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mineramcverempleados-display": {
								"semanticObject": "mineramcverempleados",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=minera.mc.verempleados",
									"url": sap.ui.require.toUrl("minera/mc/verempleados")
								}
							}
						}
					}
